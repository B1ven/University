"""
Задание "Средний балл": Вам необходимо решить задачу из реальной жизни: "школьные учителя устали подсчитывать
...
result = {students[i]: sum(grades[i])/len(grades[i]) for i in range(len(students))}
print(result)
